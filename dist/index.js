...
var KlashaButton = function (_a) {
    ...
    return (React__default['default'].createElement("button", { className: className, onClick: function () { return initializePayment(callBack); } }, text || children));
};

var KlashaContext = React.createContext({
...
var KlashaProvider = function (_a) {
    ...
    var initializePayment = useKlashaPayment(others);
    return (React__default['default'].createElement(KlashaContext.Provider, { value: { initializePayment: initializePayment, callBack: callBack } }, children));
};

var KlashaConsumerChild = function (_a) {
    var children = _a.children, ref = _a.ref;
    var _b = React.useContext(KlashaContext), initializePayment = _b.initializePayment, callBack = _b.callBack;
...
var KlashaConsumer = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(KlashaProvider, __assign({}, others, { callBack: callBack }),
        React__default['default'].createElement(KlashaConsumerChild, { ref: ref }, children)));
});

exports.KlashaButton = KlashaButton;
exports.KlashaConsumer = KlashaConsumer;
exports.useKlashaPayment = useKlashaPayment;
